...
class _$CarImpl implements _Car {
  ...
  @override
  String toString() {
    return 'Car(id: $id, model: $model, brand: $brand, price: $price, featured: $featured, images: $images)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, model, brand, price,
      featured, const DeepCollectionEquality().hash(_images));
...
abstract class _Car implements Car {
  const factory _Car(
      ...
      required final List<String> images}) = _$CarImpl;
